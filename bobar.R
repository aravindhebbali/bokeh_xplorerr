# univariate bar plot
bobar <- function(fig_height = NULL, fig_width = NULL, fig_title = NULL,
                  ...
                  x_data = NULL, data = NULL, b_hover = TRUE, bar_alpha = 1,
                  bar_width = 0.9, bar_hover = FALSE, bar_leg = FALSE,
                  bar_col = 'blue', bar_f_alpha = 1, bar_l_col = 'black',
                  bar_l_alpha = 1, add_text = FALSE, text_x = NULL,
  ...
  ba <- figure(height = fig_height, width = fig_width, title = fig_title,
    ...
    ly_bar(x = xlev, y = xdata, hover = bar_hover, alpha = bar_alpha, 
...
bob <- bobar(x_data = 'cyl', data = mtcars)
