bobox2 <- function(fig_height = NULL, fig_width = NULL, fig_title = NULL,
                   ...
                   x_data = NULL, y_data = NULL, data = NULL, box_w = 0.9, 
                   box_coef = 1.5,
                   box_col = 'blue', box_alp = 1, box_out_gly = 1,
                   box_out_size = 10, box_l_col = 'black', box_l_alp = 1,
                   box_l_width = 1, add_text = FALSE, text_x = NULL,
  ...
  p <- figure(height = fig_height, width = fig_width, title = fig_title,
    ...
    ly_boxplot(x = x_data, y = y_data, data = data, width = box_w,
               coef = box_coef, fill_alpha = box_alp, 
               outlier_glyph = box_out_gly, outlier_size = box_out_size, 
               line_color = box_l_col, line_alpha = box_l_alp,
               line_width = box_l_width)
...
boxx2 <- bobox2(x_data = 'mpg', y_data = 'cyl', data = mtcars)